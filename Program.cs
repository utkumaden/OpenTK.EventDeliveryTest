...
class MyEventArgs(EventType type) : EventArgs
{
...
class MyEventArgs1(float dummy) : MyEventArgs(EventType.Event1) { public float Dummy { get; } = dummy; }
class MyEventArgs2(float dummy) : MyEventArgs(EventType.Event2) { public float Dummy { get; } = dummy; }
class MyEventArgs3(float dummy) : MyEventArgs(EventType.Event3) { public float Dummy { get; } = dummy; }
class MyEventArgs4(float dummy) : MyEventArgs(EventType.Event4) { public float Dummy { get; } = dummy; }
class MyEventArgs5(float dummy) : MyEventArgs(EventType.Event5) { public float Dummy { get; } = dummy; }
class MyEventArgs6(float dummy) : MyEventArgs(EventType.Event6) { public float Dummy { get; } = dummy; }
class MyEventArgs7(float dummy) : MyEventArgs(EventType.Event7) { public float Dummy { get; } = dummy; }
class MyEventArgs8(float dummy) : MyEventArgs(EventType.Event8) { public float Dummy { get; } = dummy; }
class MyEventArgs9(float dummy) : MyEventArgs(EventType.Event9) { public float Dummy { get; } = dummy; }
class MyEventArgs10(float dummy) : MyEventArgs(EventType.Event10) { public float Dummy { get; } = dummy; }
class MyEventArgs11(float dummy) : MyEventArgs(EventType.Event11) { public float Dummy { get; } = dummy; }
class MyEventArgs12(float dummy) : MyEventArgs(EventType.Event12) { public float Dummy { get; } = dummy; }
class MyEventArgs13(float dummy) : MyEventArgs(EventType.Event13) { public float Dummy { get; } = dummy; }
class MyEventArgs14(float dummy) : MyEventArgs(EventType.Event14) { public float Dummy { get; } = dummy; }
class MyEventArgs15(float dummy) : MyEventArgs(EventType.Event15) { public float Dummy { get; } = dummy; }
class MyEventArgs16(float dummy) : MyEventArgs(EventType.Event16) { public float Dummy { get; } = dummy; }
